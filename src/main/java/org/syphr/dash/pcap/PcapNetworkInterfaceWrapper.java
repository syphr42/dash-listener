...
/**
 * This wrapper is needed as {@link PcapNetworkInterface#equals(Object)} and
 * {@link PcapNetworkInterface#hashCode()} are not implemented in an appropriate
 * way. The wrapper delegates all methods calls except {@link #equals(Object)}
 * and {@link #hashCode()} to {@link #pcapNetworkInterface}.
 *
...
public class PcapNetworkInterfaceWrapper
{
    ...
    /**
     * Use this Guava function in order to create a
     * {@link PcapNetworkInterfaceWrapper} instance.
     */
